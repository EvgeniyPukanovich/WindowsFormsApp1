...
namespace WindowsFormsApp1
{
    class ModelView : Form
    {
        ...
        private void CreateGame(GameModel model)
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                table.RowStyles.Add(new RowStyle(SizeType.Percent, 31));
                table.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 100f / 3));
            }
            ...
            table.Controls.Add(backButton, 0, 3);


            table.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;

            List<Button> buttons = new List<Button>();
            bool[] disabledButtons = new bool[9];
            ...
            for (int column = 0; column < 3; column++)
            {
                for (int row = 0; row < 3; row++)
                {
                    ...
                    {
                        gameModel.MakeTurn(iColumn * 3 + iRow);
                    };
                    buttons.Add(button);
